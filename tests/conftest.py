    ...
    return pd.DataFrame(
        {
            ...
            "tipo_tramite": pd.array(
                [
                    "elevacion a juicio",
                    "Remite a Departamental",
                    "ARCHIVO",
                    "elevacion a juicio (ofrece SJP)",
            ...
            [
                {
                    **base,
                    "Año": anio,
                    "Mes": mes,
                    "Dimensión": "Demanda del servicio",
                    "indicador": "Causas Ingresadas",
                    "valor": ing,
                },
                {
                    **base,
                    "Año": anio,
                    "Mes": mes,
                    "Dimensión": "Respuesta del Órgano",
                    "indicador": "Causas finalizadas (trámites de finalización)",
                    "valor": fin,
                },
                {
                    **base,
                ...
                },
                {
                    **base,
                    ...
                    "Mes": mes,
                    "Dimensión": "Planta",
                    "indicador": "Funcionarios en Dependencia",
                    "valor": 5,
                },
            ]
        )
    ...
    return pd.DataFrame(
        {
            "delito_descripcion": [
                ...
                "Amenazas",
                "Robo agravado",
                "Robo agravado",  # mismo nombre, dos códigos
                "Robo agravado por el uso de arma",
                "Hurto agravado por escalamiento",
                "Robo agravado en poblado y en banda",
            ],
    ...
    return pd.DataFrame(
        {
            ...
            "fecha_resolucion": pd.to_datetime(
                [
                    ...
                    "2024-01-25",
                    "2024-02-15",
                    "2024-04-10",  # 3 resoluciones RAW2/3
